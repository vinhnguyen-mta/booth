...
export const FilterImage: React.FC = () => {
    ...
    const {selectedFrame, capturedImages, selectedFilter, setSelectedFilter, setCurrentStep} = useAppStore();
    ...
    return (
        <Layout>
            <div className={styles.stepContainer}>
                <div className="flex items-center justify-center bg-white" style={{gap: '12rem'}}>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex items-center justify-between w-full px-4 mb-5">
                            ...
                            <div
                                className="w-9 h-9 rounded-full bg-black text-white flex items-center justify-center text-sm font-medium">56
                            </div>
                            <button
                                onClick={handleNext}
